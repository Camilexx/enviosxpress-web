...
-- Esta función calcula el precio de envío según las tarifas de ENVIOSXPRESS
...
BEGIN
    ...
    IF NOT FOUND THEN
        RETURN QUERY SELECT false, 'Ciudad no encontrada: ' || p_destino, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL;
        RETURN;
    END IF;
    ...
    IF NOT FOUND THEN
        RETURN QUERY SELECT false, 'Tarifa no encontrada', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL;
        RETURN;
    END IF;
